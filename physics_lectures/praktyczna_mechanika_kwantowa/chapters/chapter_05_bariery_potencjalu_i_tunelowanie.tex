...
Przy wyrażeniach symbolicznych \texttt{Abs[t]\textasciicircum{}2} nie zawsze uprości się tak, jak oczekujemy, bo Mathematica nie wie automatycznie, które parametry są rzeczywiste i dodatnie. Wtedy pomagają założenia:
\begin{verbatim}
